        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12" align="center">
                    ...
                    <p>Your order number is {{ Session::get('order_id') }} and Grand Total is Rp {{ Session::get('grand_total') }} (including Shipping Charges Rp. 10.000,- )</p> {{-- The Order Number is the order `id` in the `orders` database table. We stored the order id in Session in checkout() method in Front/ProductsController.php --}} {{-- Retrieving Data: https://laravel.com/docs/10.x/session#retrieving-data --}}
                </div>
            </div>
        </div>
    </div>
